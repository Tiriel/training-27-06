 ...
 */
final class Version20220629140759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, isbn VARCHAR(18) NOT NULL, title VARCHAR(255) NOT NULL, author VARCHAR(255) DEFAULT NULL, released_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        , price NUMERIC(4, 2) NOT NULL, rated VARCHAR(10) DEFAULT NULL, imdb_id VARCHAR(50) NOT NULL)');
